...
ProcessDetailsComponent.ɵfac = function ProcessDetailsComponent_Factory(t) {
  return new (t || ProcessDetailsComponent)();
};

ProcessDetailsComponent.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: ProcessDetailsComponent,
  selectors: [["process-details"]],
  inputs: {
    process: "process"
  },
  decls: 7,
  vars: 2,
  consts: [["fxLayout", "column", "fxLayoutAlign", "start stretch", 1, "p8"], [1, "mat-title", "m4"], [1, "bold", "m4"], [1, "m4"]],
...
class ProcessLinkComponent {
  constructor() {
    ...
    this.getOutline = () => this.selected ? `card-outline-primary` : this.process.isComplete ? `card-outline-green` : this.current ? `card-outline-amber` : `card-outline-accent`;

    this.linkStyle = () => this.process.isComplete ? `${this.getOutline()} background-pastel-green color-green` : this.current ? `${this.getOutline()} background-pastel-amber color-amber` : `${this.getOutline()} background-card color-text`;
  }

  ngOnInit() {
    this.icon = this.process.isComplete ? 'task_alt' : this.current ? 'pending' : 'radio_button_unchecked';
    this.iconClass = this.current ? 'material-icons-outlined' : 'material-icons';
  }

}

ProcessLinkComponent.ɵfac = function ProcessLinkComponent_Factory(t) {
  return new (t || ProcessLinkComponent)();
};

ProcessLinkComponent.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: ProcessLinkComponent,
  selectors: [["process-link"]],
  inputs: {
    selected: "selected",
    current: "current",
    process: "process",
  ...
  decls: 5,
  vars: 7,
  consts: [["fxLayout", "row", "fxLayoutAlign", "start center", 1, "cursor-pointer", "rounded", "m4", "p8", 3, "ngClass", "click"], ["fxFlex", "", 1, "m4"]],
  template: function ProcessLinkComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "section", 0);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProcessLinkComponent_Template_section_click_0_listener() {
        return ctx.action.emit(ctx.process);
      });
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "p", 1);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
  ...
  directives: [_angular_material_icon__WEBPACK_IMPORTED_MODULE_2__.MatIcon, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_1__.DefaultLayoutDirective, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_1__.DefaultLayoutAlignDirective, _angular_common__WEBPACK_IMPORTED_MODULE_3__.NgClass, _angular_flex_layout_extended__WEBPACK_IMPORTED_MODULE_4__.DefaultClassDirective, _angular_flex_layout_flex__WEBPACK_IMPORTED_MODULE_1__.DefaultFlexDirective],
  encapsulation: 2
});
...
WorkflowCardComponent.ɵfac = function WorkflowCardComponent_Factory(t) {
  return new (t || WorkflowCardComponent)();
};

WorkflowCardComponent.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  type: WorkflowCardComponent,
  selectors: [["workflow-card"]],
  inputs: {
    workflow: "workflow",
    size: "size"
  },
  ...
  decls: 5,
  vars: 4,
  consts: [["fxLayout", "column", "fxLayoutAlign", "start stretch", 1, "background-card", "elevated", "rounded", "card-outline-accent", "cursor-pointer", "p8", "m4", 3, "click"], [1, "mat-body-strong", "m4"], [1, "m4"]],
  template: function WorkflowCardComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "section", 0);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function WorkflowCardComponent_Template_section_click_0_listener() {
        return ctx.action.emit(ctx.workflow);
      });
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "p", 1);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
const Components = [ProcessDetailsComponent, ProcessLinkComponent, WorkflowCardComponent];
...
ConfirmDialog.ɵfac = function ConfirmDialog_Factory(t) {
  return new (t || ConfirmDialog)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__.MAT_DIALOG_DATA));
};
...
ConfirmDialog.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  ...
  directives: [_angular_material_button__WEBPACK_IMPORTED_MODULE_6__.MatButton, _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__.MatDialogTitle, _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__.MatDialogContent, _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__.MatDialogActions, _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__.MatDialogClose],
  encapsulation: 2
});
...
class Database {
  constructor() {
    ...
    this.getWorkflow = id => this.db.workflows.find(x => x.id === id);
  }
...
class CoreService {
  constructor() {
    ...
    this.generateInputObservable = input => (0,rxjs__WEBPACK_IMPORTED_MODULE_9__.fromEvent)(input.nativeElement, 'keyup').pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.debounceTime)(300), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_11__.map)(event => event.target.value), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_12__.distinctUntilChanged)());
  }
...
SnackerService.ɵfac = function SnackerService_Factory(t) {
  return new (t || SnackerService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_13__.MatSnackBar));
};
...
ThemeService.ɵfac = function ThemeService_Factory(t) {
  return new (t || ThemeService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_14__.OverlayContainer));
};
...
CoreModule.ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_3__.CommonModule, MaterialModule], MaterialModule]
});
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CoreModule, [{
    ...
    args: [{
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__.CommonModule, MaterialModule],
